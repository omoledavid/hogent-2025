...
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    <title>{{$general->site_name}} | {{$pageName}}</title>
        ...
        <div class="modal-content">
            <div class="flat-account">
                <div class="banner-account">
                    <img src="{{asset('assets/images/section/banner-login.jpg')}}" alt="banner">
                </div>
...
<div class="modal modal-account fade" id="modalRegister">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="flat-account">
                <div class="banner-account">
                    <img src="{{asset('assets/images/section/banner-register.jpg')}}" alt="banner">
                </div>
                <form class="form-account">
                    <div class="title-box">
                        <h4>Register</h4>
